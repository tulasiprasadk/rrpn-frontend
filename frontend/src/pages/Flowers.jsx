  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const flowerCat = cats.find((c) => (c.name || "").toLowerCase().includes("flower")) || null;
        ...
        console.error("Flowers page - load error:", error);
      ...
      {!isCompactLayout && (
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8, color: "#C8102E", fontWeight: 800, marginBottom: 12 }}>
            <CategoryIcon category="flowers" size={18} />
            Variety View
          </div>
          {varietySelector}
        </aside>
      ...
      >
        ...
        >
          <h1 style={{ margin: 0, display: "flex", alignItems: "center", gap: 10, color: "#C8102E" }}>
            <CategoryIcon category="flowers" size={22} />
            Flowers
          </h1>
          ...
          <div style={{ marginTop: 10, color: "#5A3A00", fontWeight: 700 }}>
            {selectedVariety === "All" ? `Showing ${preparedProducts.length} flower products` : `Showing ${selectedCount} products in ${selectedVariety}`}
          </div>
        </div>
        ...
        {!loading && preparedProducts.length === 0 && <p>No flowers available.</p>}
        ...
        {!loading && selectedVariety !== "All" && (
          ...
          >
            <div style={{ color: "#C8102E", fontWeight: 800, display: "flex", alignItems: "center", gap: 8 }}>
              <CategoryIcon category="flowers" variety={selectedVariety} size={18} />
              {selectedVariety}
            </div>
            <button
              type="button"
